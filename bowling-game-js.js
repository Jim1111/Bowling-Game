...
function MustickTKey(e) {
    if (setMenu && !gameSc) {
        if (keys[13] && setMenu && KeyMenu1 && MSw1) {
            musicOn=true;
            removeEventListener("click", MustickTKey);
        }
    } // setMenu
}
...
function MustickFKey(e) {
    if (setMenu && !gameSc) {
        if (keys[13] && setMenu && KeyMenu2 && MSw2) {
            musicOn=false;
            removeEventListener("click", MustickFKey);
        }
    } // setMenu
}
...
function SptickTKey(e) {
    if (setMenu && !gameSc) {
        if (keys[13] && setMenu && KeyMenu3 && MSw3) {
            speechOn=true;
            removeEventListener("click", SptickTKey);
        }
    } // setMenu
}
...
function SptickFKey(e) {
    if (setMenu && !gameSc) {
        if (keys[13] && setMenu && KeyMenu4 && MSw4) {
            speechOn=false;
            removeEventListener("click", SptickFKey);
        }
    } // setMenu
}
...
function enOnKey(e) {
    if (setMenu && !gameSc) {
        if (keys[13] && setMenu && KeyMenu5 && MSw5) {
            ...
            Grk=false;
            Tuk=false;
            removeEventListener("click", enOnKey);
        }
    }
}
...
function gerOnKey(e) {
    if (setMenu && !gameSc) {
        if (keys[13] && setMenu && KeyMenu6 && MSw6) {
            ...
            Grk=false;
            Tuk=false;
            removeEventListener("click", gerOnKey);
        }
    }
}
...
function romOnKey(e) {
    if (setMenu && !gameSc) {
        if (keys[13] && setMenu && KeyMenu7 && MSw7) {
            ...
            Grk=false;
            Tuk=false;
            removeEventListener("click", romOnKey);
        }
    }
}
...
function bulOnKey(e) {
    if (setMenu && !gameSc) {
        if (keys[13] && setMenu && KeyMenu8 && MSw8) {
            ...
            Grk=false;
            Tuk=false;
            removeEventListener("click", bulOnKey);
        }
    }
}
...
function grkOnKey(e) {
    if (setMenu && !gameSc) {
        if (keys[13] && setMenu && KeyMenu9 && MSw9) {
            ...
            Grk=true;
            Tuk=false;
            removeEventListener("click", grkOnKey);
        }
    }
}
...
function turOnKey(e) {
    if (setMenu && !gameSc) {
        if (keys[13] && setMenu && KeyMenu10 && MSw10) {
            ...
            Grk=false;
            Tuk=true;
            removeEventListener("click", turOnKey);
        }
    }
}
...
function effectsTKey(e) {
    if (setMenu && !gameSc) {
        if (keys[13] && setMenu && KeyMenu11 && MSw11) {
            effectsOn=true;
            removeEventListener("click", effectsTKey);
        }
    } // setMenu
}
...
function effectsFKey(e) {
    if (setMenu && !gameSc) {
        if (keys[13] && setMenu && KeyMenu12 && MSw12) {
            effectsOn=false;
            removeEventListener("click", effectsFKey);
        }
    } // setMenu
}
...
function endMenuKey(e) {
    if (setMenu && !gameSc) {
        if (keys[13] && setMenu && KeyMenu13 && MSw13) {

            setMenu=false;
            insSc=false;
            splashSc=true;

            removeEventListener("click", endMenuKey);
        }
    }
}
